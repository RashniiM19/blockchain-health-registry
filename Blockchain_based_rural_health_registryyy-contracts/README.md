# Blockchain_based_rural_health_registryyy-contracts
...
By default the template creates a single `HelloWorld` contract under healthregistry folder in the `smart_contracts` directory. To add a new contract:
